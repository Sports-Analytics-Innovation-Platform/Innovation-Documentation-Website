...
| **CI/CD** | Gitea Actions workflow (`.gitea/workflows/ci.yml`) — test + coverage, with a self-hosted Docker runner registered against the Gitea instance. Lint/typecheck not wired into CI yet (run manually) | Whole repo | Kiran | TBD |
