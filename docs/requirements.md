...
| **Authentication & security** | Sign up, sign in, password reset, account deletion via Passport.js, an established auth library rather than hand-rolled auth | `apps/api` (auth module) | TBD | TBD |
